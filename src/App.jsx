        ...
        <header className="header">
          <div className="header__container">
            ...
            <div className="container_children two">
              <p>
                In a world ruled by law and divine order You rise as high as
              ...
              <p>
                The infinite intelligence within you knows the answers. Its
                nature is to respond to your thoughts. Be careful of the
                thought-seeds you plant in the garden of your mind For seeds
